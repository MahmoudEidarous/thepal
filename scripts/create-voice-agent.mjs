...
const TOOLS = [
  ...
  },
  {
    name: "get_continuity",
    description:
      "Read one exact canonical continuity view: a person/place/project dossier, the user's week or month, grounded routine patterns, today's returning past, or the earned shared-humor inventory. Choose this structured projection when the question asks for one of those views; it is not a semantic search. Dossiers require about. Humor inventory never grants permission to use a callback; attention does that separately.",
    expects_response: true,
    response_timeout_secs: 10,
    parameters: params(
      {
