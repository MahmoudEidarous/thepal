...
try {
  check(ledger.stats().schemaVersion === 4, "truth tables remain active under schema migration 4");
  ...
  check(ledger.stats().schemaVersion === 4, "schema version survives restart");
