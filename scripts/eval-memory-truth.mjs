...
try {
  check(ledger.stats().schemaVersion === 5, "truth tables remain active under schema migration 5");
  ...
  check(ledger.stats().schemaVersion === 5, "schema version survives restart");
