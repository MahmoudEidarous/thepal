...
try {
  check(ledger.stats().schemaVersion === 8, "truth tables remain active under schema migration 8");
  ...
  check(ledger.stats().schemaVersion === 8, "schema version survives restart");
