...
try {
  check(ledger.stats().schemaVersion === 3, "truth tables remain active under schema migration 3");
  ...
  check(ledger.stats().schemaVersion === 3, "schema version survives restart");
